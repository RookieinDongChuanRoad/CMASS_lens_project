...
| 新增 `python -m interpolation_grids.env_check` | 让环境验证成为明确的项目入口 |
...
## Resources
- 项目说明：`/Users/liurongfu/Work/CMASS_lens_project/prepare_intepolation_grids/project.md`
- 计划文件：`/Users/liurongfu/Work/CMASS_lens_project/prepare_intepolation_grids/task_plan.md`
- 发现记录：`/Users/liurongfu/Work/CMASS_lens_project/prepare_intepolation_grids/findings.md`
- 进度日志：`/Users/liurongfu/Work/CMASS_lens_project/prepare_intepolation_grids/progress.md`
- 本地包入口：`/Users/liurongfu/Work/CMASS_lens_project/prepare_intepolation_grids/interpolation_grids/cli.py`
- HDF5 处理逻辑：`/Users/liurongfu/Work/CMASS_lens_project/prepare_intepolation_grids/interpolation_grids/io/hdf5.py`
- `s2_grid` 生产逻辑：`/Users/liurongfu/Work/CMASS_lens_project/prepare_intepolation_grids/interpolation_grids/physics/jeans.py`
- `m5` 相关逻辑：`/Users/liurongfu/Work/CMASS_lens_project/prepare_intepolation_grids/interpolation_grids/physics/m5.py`
- 环境检查入口：`/Users/liurongfu/Work/CMASS_lens_project/prepare_intepolation_grids/interpolation_grids/env_check.py`
- 标准环境声明：`/Users/liurongfu/Work/CMASS_lens_project/prepare_intepolation_grids/environment.yml`
- 运行文档：`/Users/liurongfu/Work/CMASS_lens_project/prepare_intepolation_grids/README.md`
