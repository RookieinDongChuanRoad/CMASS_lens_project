...
def get_data_spec() -> DataSpec:
    ...
    return DataSpec(
        ...
        array_fields=(
            ...
            ContextArraySpec("parent_sample_zd"),
            ContextArraySpec("parent_sample_mstar"),
            ContextArraySpec("parent_sample_log_re"),
            ContextArraySpec("parent_sample_delta_r"),
        ...
        scalar_fields=(
            ...
            ContextScalarSpec("source_z_min"),
            ContextScalarSpec("source_z_max"),
            ContextScalarSpec("source_lens_redshift_gap"),
