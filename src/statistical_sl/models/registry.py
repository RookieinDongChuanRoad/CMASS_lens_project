...
from statistical_sl.models.interfaces import ModelDefinition
from statistical_sl.models import (
    cmass,
    cmass_runtime,
    cmass_lens_only,
...
from statistical_sl.models.cmass import posterior as cmass_posterior
from statistical_sl.models.cmass_lens_only import posterior as cmass_lens_only_posterior
from statistical_sl.models.sonnenfeld2024_slacs import posterior as sonnenfeld2024_slacs_posterior
from statistical_sl.models.sonnenfeld2024_slacs_sigma_star_gamma import (
    posterior as sonnenfeld2024_slacs_sigma_star_gamma_posterior,
)
from statistical_sl.models.toy_hierarchical import posterior as toy_hierarchical_posterior
from statistical_sl.inference.model_factory import build_model_definition
