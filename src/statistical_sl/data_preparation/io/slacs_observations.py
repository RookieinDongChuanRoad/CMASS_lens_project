...
Jeans responses.  Keeping this conversion in the data-preparation workflow
preserves the separation between input construction and inference/runtime code.
"""
...
from statistical_sl.data_preparation.io.sigma_tables import build_sigma_unit_table, write_sigma_unit_table_hdf5
from statistical_sl.data_preparation.models import AperturePolicy
from statistical_sl.data_preparation.physics.jeans import COSMOLOGY, compute_sigma_unit_grid
