...
These dataclasses live in the posterior-predictive package because diagnostics
artifacts are owned by posterior-predictive workflows, not by the inference
sampler.
"""
