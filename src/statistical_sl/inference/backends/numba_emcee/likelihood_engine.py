"""Production Numba/emcee likelihood engine.
...
from statistical_sl.inference.diagnostics import (
...
def build_compiled_model(runtime_config: RuntimeConfig) -> CompiledModel:
    """
    Build the Numba/emcee compiled model for the configured registry model.
