...
def test_run_posterior_predictive_generates_expected_artifacts_for_sersic(tmp_path: Path) -> None:
    ...
    from cmass_lens_inference.posterior_predictive import run_posterior_predictive
...
def test_sigma_unit_table_from_hdf5_supports_clipped_sersic_queries(tmp_path: Path) -> None:
    ...
    from cmass_lens_inference.posterior_predictive import SigmaUnitTable
...
def test_histogram_panel_writes_left_and_right_tail_labels() -> None:
    ...
    from cmass_lens_inference.posterior_predictive import _write_histogram_panel
...
def test_histogram_window_keeps_observed_marker_near_center_without_full_tail_range() -> None:
    ...
    from cmass_lens_inference.posterior_predictive import _compute_histogram_x_limits
...
def test_histogram_panel_recomputes_hist_within_display_window() -> None:
    ...
    from cmass_lens_inference.posterior_predictive import _compute_histogram_x_limits, _write_histogram_panel
...
def test_theta_ein_std_panel_uses_fixed_histogram_window_and_small_negative_padding() -> None:
    ...
    from cmass_lens_inference.posterior_predictive import _resolve_histogram_ranges, _write_histogram_panel
...
def test_sigma_std_panel_uses_one_sided_upper_envelope_and_small_negative_padding() -> None:
    ...
    from cmass_lens_inference.posterior_predictive import _resolve_histogram_ranges
...
def test_only_theta_ein_std_uses_fixed_upper_bound_of_three() -> None:
    ...
    from cmass_lens_inference.posterior_predictive import (
...
def test_overview_figure_uses_profile_suptitle_and_latex_panel_titles(
    ...
    from cmass_lens_inference.posterior_predictive import _write_overview_figure
...
def test_wait_for_external_sigma_tables_runs_both_profiles_when_overwritten_tables_are_ready(tmp_path: Path) -> None:
    ...
    from cmass_lens_inference.posterior_predictive import wait_for_external_sigma_tables_and_run
...
def test_posterior_predictive_public_defaults_use_1000_replicates() -> None:
    ...
    from cmass_lens_inference.posterior_predictive import run_posterior_predictive, wait_for_external_sigma_tables_and_run
...
def test_select_posterior_draws_defaults_to_tail_capped_chain() -> None:
    ...
    from cmass_lens_inference.posterior_predictive import _select_posterior_draws
...
def test_resolve_candidate_pool_size_uses_new_100000_cap() -> None:
    ...
    from cmass_lens_inference.posterior_predictive import _resolve_candidate_pool_size
...
def test_reduce_population_to_mass_bins_uses_expected_bin_statistics() -> None:
    ...
    from cmass_lens_inference.posterior_predictive import _reduce_population_to_mass_bins
...
def test_write_trend_panel_uses_distinct_band_solid_and_dashed_encodings() -> None:
    ...
    from cmass_lens_inference.posterior_predictive import _write_trend_panel
...
def test_run_posterior_trends_generates_expected_artifacts_for_sersic(tmp_path: Path) -> None:
    ...
    from cmass_lens_inference.posterior_predictive import run_posterior_trends
