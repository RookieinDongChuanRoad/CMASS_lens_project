...
an inference validator.  Keeping these strings centralized prevents the writer,
tests, and future data-preparation commands from drifting apart while the
machine-readable schema is still maturing.
"""
