...
from prepare_dataset.io.hdf5 import build_galaxy_inputs
from prepare_dataset.models import AperturePolicy
from prepare_dataset.physics.jeans import compute_s2_grid, compute_sigma_unit_grid, kpc_per_arcsec, uses_devaucouleurs_branch
...
def test_compute_sigma_unit_grid_passes_float_aperture_for_boss_circular_policy(monkeypatch) -> None:
    ...
    monkeypatch.setattr("prepare_dataset.physics.jeans.sigma_model.sigma2", _fake_sigma2)
